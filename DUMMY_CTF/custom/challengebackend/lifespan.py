...
async def challenge_backend_lifespan(app: fastapi.FastAPI):
    """Connects Mongo (needed for the dh-export and export-cipher variant
    pools). Everything else in this service (primes.py, ecbcbcwtf.py,
    ecb_oracle.py) is stateless and doesn't need any of this."""
