...
from ..tasks.kap02_c45_tasks import task_02_16, task_02_17, task_02_18
...
from .kap02_shared.kap02_muster_codes import MUSTER_C5


class Kapitel_02_Challenge_5(AbstractSiteBuilder):
    ...
    def _content(self) -> rx.Component:
        ...
        return rx.vstack(
            ...
            rx.cond(
                PlayerCardState.tasks_solved["day_02_task_17"] | PlayerCardState.enable_test_mode,
                render_task(self.PAGE_ID, 18, "Aufgabe: Die Flagge", TaskWidget(task_02_18)),
            ),
            rx.cond(
    ...
    def _locked(self) -> rx.Component:
        return rx.box(
            rx.vstack(
                ...
                rx.text("Lösen Sie zuerst Challenge 4, um diese Challenge "
